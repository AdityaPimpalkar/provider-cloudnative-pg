...
// CnpgBarmanPluginBackupConfig is validated against Backup.spec.parameters and
// per-schedule parameters. Maps to cnpgv1.BackupSpec fields for plugin backups.
